      ...
      <el-col :lg="20" :xs="24">
        ...
        <el-card shadow="never" class="table-container">
          ...
          <el-table v-loading="loading" :data="pageData" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="部门" width="180" align="center" prop="deptName" />
    ...
    <el-dialog v-model="dialog.visible" :title="dialog.title" :width="dialog.width" append-to-body @close="closeDialog">
      ...
      <el-form v-if="dialog.type === 'user-form'" ref="userFormRef" :model="formData" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属部门" prop="departId">
          <el-tree-select v-model="formData.departId" placeholder="请选择所属部门" :data="deptList" node-key="id"
            :props="{ children: 'children', label: 'name', disabled: '' }" filterable check-strictly
      ...
      <el-form v-else-if="dialog.type === 'user-import'" :model="importData" label-width="100px">
        <el-form-item label="部门">
          <el-tree-select v-model="importData.deptId" placeholder="请选择部门" node-key="id"
            :props="{ children: 'children', label: 'name', disabled: '' }" :data="deptList" filterable check-strictly />
        </el-form-item>
