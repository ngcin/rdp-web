    ...
    <el-dialog v-model="dialog.visible" :title="dialog.title" destroy-on-close append-to-body width="1000px"
      ...
      <el-form ref="menuFormRef" :model="formData" :rules="rules" label-width="160px">
        <el-form-item label="父级菜单" prop="parentId">
          <el-tree-select v-model="formData.parentId" node-key="id" placeholder="选择上级菜单" :data="menuOptions" filterable
        ...
        " label="路由路径" prop="path">
          <el-input v-if="formData.type == 2" v-model="formData.path" placeholder="system" />
...
const menuOptions = ref<IdNameOption[]>([]);
